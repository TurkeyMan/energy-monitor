...
nothrow @nogc:
    ...
    void circuit_print(Session session)
    {
        ...
        void traverse(Circuit* c, uint indent)
        {
            ...
            powerLen = max(powerLen, c.meterData.active[0].value.formatFloat(null) + 1);
            ...
            currentLen = max(currentLen, c.meterData.current[0].value.formatFloat(null) + 1);
            ...
            foreach (a; c.appliances)
            {
                ...
                powerLen = max(powerLen, a.meterData.active[0].value.formatFloat(null) + 1);
                ...
                currentLen = max(currentLen, a.meterData.current[0].value.formatFloat(null) + 1);
            }
