...
//            message.append("Content-Type: application/x-www-form-urlencoded\r\n");
    ...
    void dispatchMessage(ref HTTPResponse response)
    {
        import urt.zip;
...
__gshared immutable string[] methodString = [ "GET", "HEAD", "OPTIONS", "POST", "PUT", "PATCH", "DELETE", "TRACE", "CONNECT", "SEARCH", "PROPFIND", "PROPPATCH", "MKCOL", "COPY", "MOVE", "LOCK", "UNLOCK" ];
