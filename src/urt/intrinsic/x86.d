...
version (LDC)
{
    ...
    CR32 _x86_addcarry(ubyte c_in, uint a, uint b) pure @safe;
    pragma(LDC_intrinsic, "llvm.x86.addcarry.64")
    CR64 _x86_addcarry(ubyte c_in, ulong a, ulong b) pure @safe;

    pragma(LDC_intrinsic, "llvm.x86.subborrow.32")
    CR32 _x86_subborrow(ubyte c_in, uint a, uint b) pure @safe;
    pragma(LDC_intrinsic, "llvm.x86.subborrow.64")
    CR64 _x86_subborrow(ubyte c_in, ulong a, ulong b) pure @safe;
}
