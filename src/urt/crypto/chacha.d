...
void chacha_init_context(ref chacha_context ctx, ref const ubyte[16] key, ulong nonce, ulong counter = 0, uint rounds = 20) pure
{
    chacha_init_context(ctx, key, expandNonce(nonce), counter, rounds);
}

void chacha_init_context(ref chacha_context ctx, ref const ubyte[32] key, ulong nonce, ulong counter = 0, uint rounds = 20) pure
{
    chacha_init_context(ctx, key, expandNonce(nonce), counter, rounds);
}

void chacha_init_context(ref chacha_context ctx, ref const ubyte[16] key, ref const ubyte[12] nonce, ulong counter = 0, uint rounds = 20) pure
{
...
void chacha_init_context(ref chacha_context ctx, ref const ubyte[32] key, ref const ubyte[12] nonce, ulong counter = 0, uint rounds = 20) pure
{
...
static void chacha_set_counter(ref chacha_context ctx, ulong counter) pure
{
	ctx.state[12] = cast(uint)counter;
	ctx.state[13] = ctx.nonceLow | (counter >> 32);
}

void chacha_free_context(ref chacha_context ctx) pure
{
    ctx.state[] = 0;
    ctx.keystream32[] = 0;
    ctx.position = 0;
...
size_t chacha_update(ref chacha_context ctx, const ubyte[] input, ubyte[] output) pure
{
    import urt.util : min;
...
void chacha_block_next(ref chacha_context ctx) pure
{
